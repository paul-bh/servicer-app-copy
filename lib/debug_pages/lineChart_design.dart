...
class GraphDesignPage extends StatefulWidget {
  GraphDesignPage({Key? key}) : super(key: key);

  @override
  State<GraphDesignPage> createState() => _GraphDesignPageState();
}

class _GraphDesignPageState extends State<GraphDesignPage> {
  ...
  LineChartBarData dataOne = LineChartBarData(
    ...
    belowBarData: BarAreaData(color: Color.fromARGB(33, 115, 255, 0), show: true),
  ...
  LineChartBarData dataTwo = LineChartBarData(
    ...
    barWidth: 6,
    isStrokeCapRound: true,
    belowBarData: BarAreaData(color: Color.fromARGB(34, 255, 153, 0), show: true),
    spots: [
      FlSpot(1, 10000),
      FlSpot(2, -50000),
      FlSpot(3, 80000),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color.fromARGB(255, 206, 82, 255), Color.fromARGB(255, 141, 115, 255)],
                  ...
                  LineChartData(
                    gridData: FlGridData(
                      getDrawingHorizontalLine: (double value) =>
                          FlLine(color: Color.fromARGB(69, 255, 255, 255), strokeWidth: 1),
